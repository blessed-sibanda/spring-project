...
public class PersistenceTests extends MongoDbTestBase {
    ...
    void getProductById() {
        StepVerifier.create(repository.findByProductId(savedEntity.getProductId()))
                .expectNextMatches(foundEntity ->
                        areProductEqual(savedEntity, foundEntity))
                .verifyComplete();
    }
    ...
    void duplicateError() {
        ...
        StepVerifier.create(repository.save(entity)).expectError(
    ...
    void optimisticLockError() {
        ...
        ProductEntity entity1 =
                repository.findById(savedEntity.getId()).block();
        ...
        // Get the updated entity form the database and verify its new state
        StepVerifier.create(repository.findById(savedEntity.getId()))
                        .expectNextMatches(foundEntity ->
                                foundEntity.getVersion() == 1
    ...
    private boolean areProductEqual(ProductEntity expectedEntity,
